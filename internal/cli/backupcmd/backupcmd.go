...
// (solov2-1tof). The remaining backup subcommands (create/verify/prune) already
// delegate to internal/infrastructure/backup; this package covers `list`, which
// is pure on-disk reporting with no infrastructure counterpart.
package backupcmd
