...
func TestViolationDetection(t *testing.T) {
	...
	tests := []struct {
		...
		// core/* → application/* is forbidden
		{
			...
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/core/domain",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/application",
			wantViol: true,
		},
		// core/* → infrastructure/* is forbidden
		{
			...
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/core/domain",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/infrastructure/vector",
			wantViol: true,
		},
		// core/ports → infrastructure/* is forbidden
		{
			name:     "core/ports imports infrastructure is forbidden",
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/core/ports",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/infrastructure/vector",
			wantViol: true,
		},
		// application/* → infrastructure/* is forbidden
		{
			...
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/application",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/infrastructure/vector",
			wantViol: true,
		},
		// application/* → core/ports/* is allowed
		{
			...
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/application",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/core/ports",
			wantViol: false,
		},
		// application/* → core/domain/* is allowed
		{
			...
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/application",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/core/domain",
			wantViol: false,
		},
		// unrelated packages — no violation
		{
			name:     "infrastructure imports core is fine",
			importer: "github.com/whiskeyjimbo/engram/solov2/internal/infrastructure/vector",
			imported: "github.com/whiskeyjimbo/engram/solov2/internal/core/ports",
			wantViol: false,
		},
		{
